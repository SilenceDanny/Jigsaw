    ...
    <body>
        ...
        <div id="content">
            <div id="sidebar" style="float: left;width: 200px;height: 1024px;background: #D7DADB;box-shadow: #573544">
                ...
                <button id="createColla" onclick="createColla()">Create Colla.Game</button>
                <button id="joinColla" onclick="joinColla()">Join Colla.Game</button>
            </div>
        {{-- 拼图场景 --}}
